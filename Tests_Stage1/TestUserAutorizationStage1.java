...
public class TestUserAutorizationStage1 {
	...
	public void loginAsDeactivateUser() throws Exception {
		...
		userAuthorizationPage.logIn(Config.deactivateUserStage1, Config.password);
	...
	public void loginWithWrongPassword() throws Exception {
		...
		userAuthorizationPage.logIn(Config.auto_customer_1, Config.wrongPassword);
		// проверяем наличие сообщения об ошибке
		userAuthorizationPage.checkErrorMessagePresent();
	}
